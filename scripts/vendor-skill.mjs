 ...
 *
 * USAGE
 *   node scripts/vendor-skill.mjs           regenerate scripts/lib/
 *   node scripts/vendor-skill.mjs --check   fail if stale (CI / pre-submission)
 *
...
const BANNER = (sourcePath) =>
  ...
  ` *\n` +
  ` * Generated from ${sourcePath} by scripts/vendor-skill.mjs.\n` +
