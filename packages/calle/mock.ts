...
/**
 * The `call.state` sequence each scenario walks through, so the dashboard's
 * state machine (frontend doc §4.2) can be exercised without a live call.
 */
const STATE_SEQUENCES: Record<MockScenario, CallStatus[]> = {
  accept_immediately:    ["queued", "dialling", "connected", "in_conversation", "extracting", "completed"],
  accept_after_pushback: ["queued", "dialling", "connected", "in_conversation", "extracting", "completed"],
  hard_refusal:          ["queued", "dialling", "connected", "in_conversation", "extracting", "completed"],
  callback_requested:    ["queued", "dialling", "connected", "in_conversation", "extracting", "completed"],
  late_eta:              ["queued", "dialling", "connected", "in_conversation", "extracting", "completed"],
  ambiguous:             ["queued", "dialling", "connected", "in_conversation", "extracting", "completed"],
  ...
  gatekeeper:            ["queued", "dialling", "connected", "in_conversation", "extracting", "completed"],
  no_answer:             ["queued", "dialling", "no_answer"],
  call_drops:            ["queued", "dialling", "connected", "in_conversation", "failed"],
};
...
async function runCall(
  ...
  for (const state of states) {
    ...
    // Transcript arrives while the parties are actually talking.
